 ...
 *
 * @see \Drupal\decoupled_skeleton\Entity\Customers.
 */
class CustomersAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\decoupled_skeleton\Entity\CustomersInterface $entity */
